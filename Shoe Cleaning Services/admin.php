...
<div class="w3-top w3-hide-small">
  <div class="w3-bar w3-xlarge w3-black w3-opacity w3-hover-opacity-off" id="myNavbar">
    ...
    <a href="view_admin.php" class="w3-bar-item w3-button">VIEW ORDER</a>
...
<div class="w3-container w3-black w3-padding-64 w3-xxlarge" id="menu">
  <div class="w3-content">
    ...
    while($row = mysqli_fetch_assoc($result)) {
      ...
      <p class="w3-text-grey"><a href="edit_admin.php?id=<?php echo $row["id"]; ?>">Edit</a></td>
      <p class="w3-text-grey"><a href="delete_admin.php?id=<?php echo $row["id"]; ?>">Delete</a></td>
      <hr>
      <?php
         } ?>
             <p class="w3-text-grey"><a href="insert_admin.php">Add Service</a></td>
    </div>
...
<div class="w3-container w3-padding-64 w3-blue-grey w3-grayscale-min w3-xlarge" id="myMap">
  <div class="w3-content">
    ...
    <form action="feedbackview.php">
      <p><button class="w3-button w3-light-grey w3-block" type="submit">VIEW FEEDBACK</button></p>
    </form>
  </div>
</div>
