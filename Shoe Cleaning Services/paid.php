...
<div class="form">
<span class="w3-text-white w3-hide-small" style="font-size:100px"><h1>View Paid Orders</h1></span>
...
<?php
$count=1;
$sql="Select * from booking where name = '$name' and status = 'paid';";
